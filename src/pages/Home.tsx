...
import { Search, Eye, MessageCircle, UtensilsCrossed, Users, Clock, Shield, Star, Plus, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Home = () => {
  ...
  const steps = [
    {
      icon: Search,
      title: 'Search',
      description: 'Find tiffin providers in your area using our smart search filters.'
    },
    {
      icon: Eye,
      title: 'View Details',
      description: 'Browse menus, prices, and reviews to find the perfect match.'
    },
    {
      icon: MessageCircle,
      title: 'Contact',
      description: 'Connect directly with providers via phone, WhatsApp, or email.'
    },
    {
      icon: UtensilsCrossed,
      title: 'Enjoy Meals',
      description: 'Relish delicious homemade meals delivered fresh to your door.'
    }
  ];
  ...
  const features = [
    {
      ...
      description: 'All our tiffin providers are verified for quality and hygiene.'
    },
    {
      icon: Clock,
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            >
              Discover authentic homemade tiffin services in your area. Fresh, affordable, 
              and delicious meals prepared with love, delivered to your doorstep.
            </motion.p>
            ...
            >
              <Button asChild size="lg" className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-full">
                <Link to="/search" className="text-white hover:text-white flex items-center">
                  <Search className="mr-2 h-5 w-5" />
                  Find Tiffin Services
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white px-8 py-3 rounded-full">
                <Link to="/become-provider" className="flex items-center text-orange-600 hover:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Explore our variety of authentic homemade cuisines from verified providers
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              Students, working professionals, and families struggle daily with finding 
              affordable, healthy, and tasty meals. Restaurant food is expensive, 
              processed food is unhealthy, and cooking daily is time-consuming.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <div className="inline-flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-4 px-8 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                <Link to="/search" className="flex items-center text-white hover:text-white">
                  <Search className="mr-2 h-5 w-5" />
                  Start Your Journey
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-2 border-orange-300 text-orange-600 hover:bg-orange-50 font-semibold py-4 px-8 rounded-full transition-all duration-300">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join thousands of satisfied customers who found their perfect tiffin service
            </p>
          </motion.div>
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <motion.div variants={itemVariants}>
          ...
          >
            Join our community today and discover amazing homemade meals near you.
            Fresh, affordable, and full of love!
          </motion.p>

          {/* CTA Buttons */}
          <motion.div className="flex flex-col items-center sm:flex-row gap-4 sm:gap-6">
  {/* Search Button */}
  ...
  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
    <Button
      ...
      size="lg"
      variant="outline"
      className="border border-white/40 bg-none text-white hover:text-orange-200 hover:border-orange-200 hover:bg-white/10 backdrop-blur-md px-8 py-3 rounded-full text-base font-semibold transition-all duration-300"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10">
        ...
        >
          <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28..." opacity="0.3" />
